...
<div class="constitution">
    ...
    <div class="subBlock">
        <p>A total of 7 veto votes are required to veto a trade. Vetoes are only appropriate in instances of collusion or an egregious mismatch of value (i.e. CMC for a 3rd string RB). Not liking a trade does not warrant a veto.</p>
    </div>
    ...
    <p>FAAB budgets will reset each season in the off-season.</p>
    ...
    <p>At the end of the season the 6 teams with highest win/loss will make the playoffs. The first round of playoffs will commence in week 15 and the championship will be week 17. Week 18 will not be used.</p>
